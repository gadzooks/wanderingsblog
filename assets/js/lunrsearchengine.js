...
var documents = [{
    ...
    "body": "2023/06/05 - I recently spent an adventurous day hiking with my friend Phil and our beloved pet Baloo in Bandera Mountain, Washington State. The entire trail was lined with old-growth trees, wildflowers and in the backdrop, the gorgeous Cascades mountain range. We chose to embark on our journey in the evening as we wanted to watch the sunset while we hiked. The entire hike was filled with adventure. Baloo, my canine companion did not show signs of fatigue and loved the entire journey. Though the climb was rocky, the result was worth it. The sun was painting the sky with a canvas of oranges and golds as we reached the top. The view we were able to witness was pure bliss.   Bandera mountain sunset hike with Phil  Bandera mountain sunset hike with Phil  Bandera mountain sunset hike with Phil  Bandera mountain sunset hike with Phil  Bandera mountain sunset hike with Phil"
    }, {
    "id": 9,
    "url": "/2023/05/lakeshore-hiking-adventure-memorial-day-getaway.html",
    "title": "Lakeshore Hiking Adventure: Memorial Day Getaway",
    "body": "2023/05/27 - I recently had the opportunity to spend a three-day memorial weekend in beautiful Lake Chelan. I decided to get out and explore the great outdoors along the lakeshore trail. The trek started out with a very pleasant hike and went along the beautiful lake, making my journey full of oceanic views. The path was easy to follow and the terrain was mostly flat and with very few changes. The peak of my journey was reaching a viewpoint which provided a stunning view of Lake Chelan and I had the perfect spot to rest and enjoy the sunset. I was able to complete the hiking trail in two nights and I’m very grateful to have had such an incredible experience.   LakeShore trail 2023    LakeShore trail 2023  LakeShore trail 2023  LakeShore trail 2023"
    }, {
    "id": 10,
