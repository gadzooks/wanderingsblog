...
var documents = [{
    ...
    "body": "2023/01/22 - Heather Lake Trail is a 4. 4-mile hiking trail located in the North Cascades of Washington state. This trail contains spectacular views of the lush mountain landscape, including waterfalls, meadows filled with wildflowers, and distant mountain peaks. The trail is best traveled during the summer months and is great for hikers of all skill levels. Stunning vistas of the surrounding mountains, as well as snow-capped peaks, can be seen from the Heather Lake viewpoint. An additional advantage of this trail is the abundant wildlife, such as black bears, mountain goats, and bald eagles, that can be seen along the way.   Heather lake trail  Heather lake trail  Heather lake trail  Heather lake trail  Heather lake trail"
    }, {
    "id": 10,
    "url": "/costa-rica-trip/",
